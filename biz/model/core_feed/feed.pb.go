...
func (x *ToytokFeedRequest) Reset() {
	*x = ToytokFeedRequest{}
...
func (x *ToytokFeedRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ToytokFeedRequest) ProtoMessage() {}

func (x *ToytokFeedRequest) ProtoReflect() protoreflect.Message {
	mi := &file_feed_proto_msgTypes[0]
...
// Deprecated: Use ToytokFeedRequest.ProtoReflect.Descriptor instead.
func (*ToytokFeedRequest) Descriptor() ([]byte, []int) {
	return file_feed_proto_rawDescGZIP(), []int{0}
}

func (x *ToytokFeedRequest) GetLatestTime() int64 {
...
func (x *ToytokFeedRequest) GetToken() string {
...
type ToytokFeedResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ToytokFeedResponse) Reset() {
	*x = ToytokFeedResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ToytokFeedResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ToytokFeedResponse) ProtoMessage() {}

func (x *ToytokFeedResponse) ProtoReflect() protoreflect.Message {
	mi := &file_feed_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ToytokFeedResponse.ProtoReflect.Descriptor instead.
func (*ToytokFeedResponse) Descriptor() ([]byte, []int) {
	return file_feed_proto_rawDescGZIP(), []int{1}
}

func (x *ToytokFeedResponse) GetStatusCode() int32 {
...
func (x *ToytokFeedResponse) GetStatusMsg() string {
...
func (x *ToytokFeedResponse) GetVideoList() []*Video {
	if x != nil {
		return x.VideoList
	}
	return nil
...
func (x *ToytokFeedResponse) GetNextTime() int64 {
...
var file_feed_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x66, 0x65, 0x65, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x63, 0x6f,
	0x72, 0x65, 0x2e, 0x66, 0x65, 0x65, 0x64, 0x22, 0x4c, 0x0a, 0x13, 0x74, 0x6f, 0x79, 0x74, 0x6f,
	0x6b, 0x5f, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f,
	...
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xa4, 0x01, 0x0a, 0x14, 0x74, 0x6f, 0x79, 0x74, 0x6f, 0x6b,
	...
	0x28, 0x0b, 0x32, 0x10, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x66, 0x65, 0x65, 0x64, 0x2e, 0x56,
	...
	0x28, 0x03, 0x52, 0x08, 0x6e, 0x65, 0x78, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xfb, 0x01, 0x0a,
	0x05, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x02,
	0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x27, 0x0a, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72,
	0x18, 0x02, 0x20, 0x02, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x66, 0x65,
	...
	0x02, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0x91, 0x01, 0x0a, 0x04, 0x55,
	...
	0x20, 0x02, 0x28, 0x08, 0x52, 0x08, 0x69, 0x73, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x42, 0x1d,
	0x5a, 0x1b, 0x74, 0x6f, 0x79, 0x2d, 0x74, 0x6f, 0x6b, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f,
	0x64, 0x65, 0x6c, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x5f, 0x66, 0x65, 0x65, 0x64,
}
...
var file_feed_proto_goTypes = []interface{}{
	(*ToytokFeedRequest)(nil),  // 0: core.feed.toytok_feed_request
	(*ToytokFeedResponse)(nil), // 1: core.feed.toytok_feed_response
	(*Video)(nil),              // 2: core.feed.Video
	(*User)(nil),               // 3: core.feed.User
}
var file_feed_proto_depIdxs = []int32{
	2, // 0: core.feed.toytok_feed_response.video_list:type_name -> core.feed.Video
	3, // 1: core.feed.Video.author:type_name -> core.feed.User
...
func file_feed_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_feed_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ToytokFeedRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_feed_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ToytokFeedResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
